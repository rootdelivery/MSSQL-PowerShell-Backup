BACKUP DATABASE [$(DBNAME)] TO  DISK = N'$(BPATH)$(BFILE)' WITH DIFFERENTIAL, RETAINDAYS = 21, NOFORMAT, NOINIT, NAME = N'$(BNAME)', SKIP, REWIND, NOUNLOAD, COMPRESSION, STATS = 10, CHECKSUM
GO
